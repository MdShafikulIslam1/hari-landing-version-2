  ...
  return (
    <section className="">
      <div className="holder">
        {/* Top */}
        <div
          className="pt-16 pb-6 relative bg-[#e04907] rounded-tl-xl rounded-tr-xl"
          style={{ backgroundImage: "url('/png-pattern2.png')" }}
        >
          ...
          <h3 className="mb-4 text-2xl font-semibold text-center">
            স্বাস্থ্যকর ও ঘন চুলকে হ্যাঁ বলুন
          </h3>
        ...
        >
          <h3 className="mb-4 px-4 text-2xl font-semibold text-center">
            কীভাবে দ্রুত আপনার চুলের পূর্বের সৌন্দর্য ফিরে পাবেন?
          </h3>

          <div className="px-8 flex flex-col items-center justify-center md:flex-row md:items-start md:justify-evenly">
            <WhyUsCard
              src="/step1.png"
              text="4 সপ্তাহের একটি সম্পূর্ণ কোর্স"
              key={0}
            />
            <div className="self-center text-6xl font-bold">...</div>
            <WhyUsCard
              src="/step2.png"
              text="আপনি সহজেই এই শ্যাম্পুটি পুরো এক মাস ব্যবহার করতে পারেন"
              key={1}
            />
            <div className="self-center text-6xl font-bold">...</div>
            <WhyUsCard src="/step3.png" text="ঘন ও সুন্দর চুল" key={2} />
          </div>
        </div>
      </div>
    </section>
