    ...
    <section className="">
      <div className="holder">
        ...
        <div className="flex flex-col md:flex-row gap-8 bg-[rgb(239,209,174)] text-black rounded-xl overflow-hidden">
          <div
            className="w-full md:w-2/6 h-72 md:h-auto bg-cover md:bg-left bg-no-repeat"
            style={{ backgroundImage: "url('/effect_img.png')" }}
          ></div>

          {/* Text */}
          <div className="md:w-4/6 px-8 py-6 flex flex-col gap-2">
            <h3 className="text-2xl font-semibold text-[rgb(224,74,8)]">
              এর প্রভাব সারা বিশ্ব থেকে শত শত পুরুষ এবং মহিলাদের দ্বারা প্রমাণিত
              হয়েছে
            </h3>
            <div className="h-[1px] bg-[rgb(224,74,8)]"></div>

            <p className="text-lg">
              Hair Surge Shampoo এর ৪ সপ্তাহের কোর্সটি চমৎকার ফলাফল দেয়।
            </p>
          </div>
        </div>
  ...
  return (
    <div className="w-48">
      ...
      <div className="mb-6 w-48 h-48 relative rounded-xl border-4 border-white">
        <div className="w-3/5 absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 px-4 py-2 flex items-center justify-center font-bold bg-white text-black rounded-xl">
          {props.des}
        </div>
