      ...
      <div className="holder px-8 py-6 flex flex-col md:flex-row rounded-xl">
        ...
        <div className="md:w-4/6 flex flex-col justify-center">
          <h3 className="mb-4 text-3xl font-bold">
            আমাদের কাস্টমার কেয়ার ম্যানেজার আপনার সাথে যোগাযোগ করবেন
          </h3>
          <p className="mb-4">
            চুলের বৃদ্ধির জন্য Hair Surge Shampoo শুধুমাত্র মূল প্যাকেজিংয়ে
            বিক্রি হয়!
          </p>
          <p className="mb-4">
            নকল থেকে সাবধান! শুধুমাত্র আসল Hair Surge Shampoo কিনুন।
          </p>
        </div>
      </div>
    </section>
